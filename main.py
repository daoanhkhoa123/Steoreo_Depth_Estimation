...
def main():
    number = int(input(
        "Please enter the dataset number (1/2/3) to use for calculating the depth map\n"))
    img1 = cv2.imread(f"house_0.png", 0)
    img2 = cv2.imread(f"house_1.png", 0)
    ...
    rectified_pts1 = rectified_pts2 = img1_rectified = img2_rectified = None
    max_iter = 100
